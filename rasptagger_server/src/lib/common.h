...
/* "char" means "universal character" */
typedef unsigned char uchar;

/* String allocator */
char *allocate_string(char *from, char *text);

/* Duplicate a string. */
char *string_dup( char *old_string );
...
char get_option(int argc, char *argv[], char *options,
			int *arg, int *i);
BOOL get_opt_int(char *argv[], int *result, int *arg, int *i,
			char letter);
BOOL get_opt_double(char *argv[], double *result, int *arg,
			int *i, char letter);
BOOL get_opt_string(char *argv[], char *result, unsigned int maxbuff,
...
extern char *anchor_text; /* Serves both as tag in printing form and word */
extern Tag  anchor_tag;

/* Text of anchor and special words */
extern char *number_text;
