...
/* Special characters */
#define ScoreSep ('@')
static char *LOBTagSep  ="_";
static char *PennTagSep = "/|";
#define PennAltern ('|')
#define PennExtraSep (':')

/* Line from corpus and pointer to it */
#define MaxLine (10000)
static char corpus_line[MaxLine];
static char *line_ptr;			/* NULL at eof */
...
static int get_corpus_word(FILE *fp, char *text, int max)
{
	int i = 0;
