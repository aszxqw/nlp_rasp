...
/* char *anchor_text = "0ANCHOR"; */
char *anchor_text = "^";	/* LOB sentence marker */
char *number_text = "0NUMBERS";
...
char *string_dup( char *old_string )
{
  ...
  Allocate(c_new_string, (strlen((char *)old_string)+1)*sizeof(char), "c_new_string: string_dup");
  strcpy( (char *)c_new_string, (char *)old_string );
